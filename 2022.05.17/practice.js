...
// let count = 0;
// let result = dummyText.filter(index => {
//   if(index === "of"){
//     count++;
//     return count;
//   };
...
// let mapping = dummyText.map(function(value,index,array){
// if(value === "dummy"){
//   value = "sementic";
// }
// });

// let test = dummyText.map(a => {if(a === "dummy") {value = "sementic"} });
